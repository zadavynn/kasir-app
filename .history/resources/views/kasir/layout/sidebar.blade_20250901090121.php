...
<nav class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 250px; min-height: 100vh;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item mb-1">
            <a href="{{ route('kasir.transaksi.view') }}" class="nav-link {{ request()->is('transaksi') ? 'active' : 'link-dark' }}">
...
<!-- Jangan lupa untuk load Bootstrap Icons di layout utama jika ingin ikon muncul -->
